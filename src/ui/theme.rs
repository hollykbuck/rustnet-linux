...
pub const fn label() -> Color {
    Color::Gray
}
pub const fn key() -> Color {
    Color::Cyan
}
...
// Protocol Colors
pub const fn proto_https() -> Color {
    Color::Green
}
pub const fn proto_quic() -> Color {
    Color::Cyan
}
pub const fn proto_http() -> Color {
    Color::Yellow
}
pub const fn proto_dns() -> Color {
    Color::Blue
}
pub const fn proto_ssh() -> Color {
    Color::Magenta
}
pub const fn proto_other() -> Color {
    Color::White
}

// Traffic Colors
pub const fn rx() -> Color {
    Color::Green
}
pub const fn tx() -> Color {
    Color::Blue
}

// TCP State Colors
pub const fn tcp_established() -> Color {
    Color::Green
}
pub const fn tcp_opening() -> Color {
    Color::Yellow
}
pub const fn tcp_closing() -> Color {
    Color::Red
}
pub const fn tcp_waiting() -> Color {
    Color::DarkGray
}
pub const fn tcp_closed() -> Color {
    Color::Gray
}
...
pub const fn bold_fg(color: Color) -> Style {
...
pub fn field_local_addr() -> Style {
    fg(Color::Rgb(152, 195, 121))
}
pub fn field_remote_addr() -> Style {
    fg(Color::Rgb(97, 175, 239))
}
pub fn field_process() -> Style {
    fg(Color::Rgb(224, 108, 117))
}
pub fn field_service() -> Style {
    fg(Color::Rgb(209, 154, 102))
}
pub fn field_location() -> Style {
    fg(Color::Rgb(198, 120, 221))
}
pub fn field_application() -> Style {
    fg(Color::White)
}
