...
pub fn draw_help(f: &mut Frame, area: Rect) -> anyhow::Result<()> {
    let help_text: Vec<Line> = vec![
        ...
        Line::from(vec![
            Span::styled("h ", fg(key())),
            Span::raw("Toggle this help screen"),
        ]),
        Line::from(vec![
            Span::styled("i ", fg(key())),
